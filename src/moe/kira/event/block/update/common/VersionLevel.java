package moe.kira.event.block.update.common;
...
public class VersionLevel {
    ...
    public static String strip() {
        return stripVersion == null ? (stripVersion = (level == Version.UNKNOWN ? "unknown" : "v" + level.toString().substring(10))) : stripVersion;
    }
